...
const Phone = ({
  ...
  return (
    <div className="w-[25%] mx-auto fixed inset-0">
      <motion.img
        style={{
          y,
          scale,
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="flex-col flex justify-center text-4xl tracking-tight font-bold text-white items-center gap-4 py-12 text-center"
      >
        {title}
        <nav className="flex gap-2">
          <button className="flex text-xs  h-10 w-[110px] border border-white/10 rounded-full items-center justify-between px-4">
            <span className="h-4">
              <AppleIcon />
            </span>
